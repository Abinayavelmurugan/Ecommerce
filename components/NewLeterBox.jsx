...
const NewLeterBox = () => {
  ...
  return (
    <div className='text-center'>
        ...
        <p className='text-gray-400 mt-3'>Here is the wonderful oppourtunity to subsribe to our newsletter</p>
        <form onSubmit={onSubmitHandler} action="" className='w-full sm:w-1/2 flex items-center gap-3 mx-auto my-6 border pl-3'>
            ...
            <button type='submit' className='bg-gray-400 text-white text-xs px-10 py-4'>SUBSCRIBE</button>
        </form>
    </div>
  )
}

export default NewLeterBox
